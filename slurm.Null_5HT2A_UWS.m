...
#SBATCH --job-name=NULL_5HT2A_UWS
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/UWS_Null_5HT2A_A%A_%a.out
#SBATCH --error=outputs/UWS_Null_5HT2A_A%A_%a.err
...
null = load('AAL/5HT2a_cimbi_hc29_beliveau_Nulls.mat');
null_ratio = null.receptor(1:90, 1);
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/UWS_Null_5HT2A/%02d',REP-1))
    save(sprintf('Results/UWS_Null_5HT2A/%02d/job_%03d.mat',REP-1,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
