...
#SBATCH --job-name=NegPerturb5HT6
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Neg_Wgain_5HT6_A%A_%a.out
#SBATCH --error=outputs/MCS_Neg_Wgain_5HT6_A%A_%a.err
...
%struc = load("NotPassedBetas5HT6MCS.mat");
...
gen=load('AAL/5HT6_gsk_hc30_radhakrishnan.csv');
gen=gen(1:90);
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Neg_Wgain_5HT6/%02d',REP))
    save(sprintf('Results/MCS_Neg_Wgain_5HT6/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
