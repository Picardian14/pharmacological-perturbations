...
#SBATCH --job-name=NegPerturbD2
#SBATCH --cpus-per-task=2
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Neg_Wgain_D2_A%A_%a.out
#SBATCH --error=outputs/MCS_Neg_Wgain_D2_A%A_%a.err
...
gen=load('AAL/D2_flb457_hc37_smith.csv');
gen=gen(1:90);
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Neg_Wgain_D2/%02d',REP))
    save(sprintf('Results/MCS_Neg_Wgain_D2/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
