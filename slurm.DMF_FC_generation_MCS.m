...
#SBATCH --job-name=FCGenerationMCS
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-50
#SBATCH --output=outputs/FC_MCS_A%A_%a.out
#SBATCH --error=outputs/FC_MCS_A%A_%a.err
...
for nsub=1:NREP
   ...
   %%%% BOLD empirical
    ...
    %save(sprintf('Results/FCGeneration/MCS_FC_generation%d.mat', s),'FC_simul2');
...
save(sprintf('Results/FCGeneration/G175_MCS/MCS_G175_%d.mat', s+100),'FC_simul2');
