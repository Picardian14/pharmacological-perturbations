...
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Neg_Wgain_5HT2A_A%A_%a.out
#SBATCH --error=outputs/MCS_Neg_Wgain_5HT2A_A%A_%a.err
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Neg_Wgain_5HT2A/%02d',REP-1))
    save(sprintf('Results/MCS_Neg_Wgain_5HT2A/%02d/job_%03d.mat',REP-1,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
