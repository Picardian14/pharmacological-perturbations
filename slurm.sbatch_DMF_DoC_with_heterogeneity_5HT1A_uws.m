...
#SBATCH --job-name=NegPerturb5HT1AUWS
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/UWS_Neg_Wgain_5HT1A_A%A_%a.out
#SBATCH --error=outputs/UWS_Neg_Wgain_5HT1A_A%A_%a.err

#Load Matlab 2017a module
ml MATLAB

matlab -nojvm -nodisplay<<-EOF
%struc = load("NotPassedBetas5HT1Auws.mat");
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/UWS_Neg_Wgain_5HT1A/%02d',REP))
    save(sprintf('Results/UWS_Neg_Wgain_5HT1A/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
