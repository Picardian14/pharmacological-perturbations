...
#SBATCH --job-name=NegPerturb5HT1A
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Neg_Wgain_5HT1A_A%A_%a.out
#SBATCH --error=outputs/MCS_Neg_Wgain_5HT1A_A%A_%a.err
...
%struc = load("NotPassedBetas5HT1AMCS.mat");
...
gen=load('AAL/5HT1a_cumi_hc8_beliveau.csv');
gen=gen(1:90);
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Neg_Wgain_5HT1A/%02d',REP))
    save(sprintf('Results/MCS_Neg_Wgain_5HT1A/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
    %save(sprintf('Results/MCS_Neg_Wgain_5HT/job_%03d.mat',s),'GBCfitt','FCfitt','FCDfitt','FC_simul','mFR');
end
