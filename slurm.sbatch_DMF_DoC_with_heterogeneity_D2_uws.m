...
#SBATCH --job-name=NegPerturbD2UWS
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/UWS_Neg_Wgain_D2_A%A_%a.out
#SBATCH --error=outputs/UWS_Neg_Wgain_D2_A%A_%a.err
...
%struc = load("NotPassedBetasD2UWS.mat");
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/UWS_Neg_Wgain_D2/%02d',REP))
    save(sprintf('Results/UWS_Neg_Wgain_D2/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
