...
#SBATCH --job-name=NULL_D2_UWS
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/UWS_Null_D2_A%A_%a.out
#SBATCH --error=outputs/UWS_Null_D2_A%A_%a.err
...
null = load('AAL/D2_flb457_hc37_smith_Nulls.mat');
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/UWS_Null_D2/%02d',REP-1))
    save(sprintf('Results/UWS_Null_D2/%02d/job_%03d.mat',REP-1,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
