...
#SBATCH --job-name=NULL_5HT2A_MCS
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Null_5HT2A_A%A_%a.out
#SBATCH --error=outputs/MCS_Null_5HT2A_A%A_%a.err
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Null_5HT2A/%02d',REP-1))
    save(sprintf('Results/MCS_Null_5HT2A/%02d/job_%03d.mat',REP-1,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
