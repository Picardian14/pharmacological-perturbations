...
#SBATCH --job-name=NegPerturbD1
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=3G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-101
#SBATCH --output=outputs/MCS_Neg_Wgain_D1_A%A_%a.out
#SBATCH --error=outputs/MCS_Neg_Wgain_D1_A%A_%a.err
...
%struc = load("NotPassedBetasD1MCS.mat");
...
gen=load('AAL/D1_SCH23390_hc13_kaller.csv');
gen=gen(1:90);
...
for REP=1:20
    ...
    %%%
    mkdir(sprintf('Results/MCS_Neg_Wgain_D1/%02d',REP))
    save(sprintf('Results/MCS_Neg_Wgain_D1/%02d/job_%03d.mat',REP,s),'FCDfitt','GBCfitt','FCfitt','FC_simul','mFR','FC_emp');
